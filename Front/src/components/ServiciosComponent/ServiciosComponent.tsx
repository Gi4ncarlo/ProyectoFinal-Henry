...
const ServicesComponent = () => {
  ...
  const services = [
    {
      ...
      images: ["/images/servicioJardin2.webp", "/images/servicioJardin1.webp", "/images/servicioJardin3.webp"],
      },
    {
      id: "Landscaping",
      ...
      description:
       ...
       images: ["/images/Pasiajismo1.webp", "/images/Paisajismo2.webp", "/images/Paisajismo3.webp", "/images/Paisajismo4.webp"],
      },
    {
      ...
      description:
       ...
       images: ["/images/riego1.webp", "/images/riego2.webp", "/images/riego3.webp", "/images/riego4.webp"], 
      },
    {
      id: "Trimming",
      shortTitle: "Podas", 
      ...
      description:
        ...
        images: ["/images/podador1.webp", "/images/podador2.webp", "/images/podador3.webp", "/images/podador4.webp"], 
    },
    {
      ...
      description:
        ...
        images: ["/images/disenio.webp", "/images/disenio2.webp", "/images/disenio3.webp"], 
      },
    {
      ...
      description:
        ...
        images: ["/images/creacionPaisajes.webp", "/images/creacionPaisajes2.webp", "/images/creacionPaisajes3.webp"], 
      },
    {
      id: "PestControl",
      shortTitle: "Plagas", 
      ...
      description:
       ...
       images: ["/images/plagas.webp", "/images/plagas2.webp", "/images/plagas3.webp", "/images/plagas4.webp"],
      },
  ];
  ...
  return (
    ...
    >
        ...
        <nav className="text-center p-4 w-full bg-gradient-to-r from-[#4CAF50] to-[#8BC34A] opacity-90 mb-12">
          <ul className="flex justify-center space-x-6 text-white">
            {services.map((service) => (
              <li key={service.id} className="relative group">
                ...
                <a
                  href={`#${service.id}`}
                  className="block px-4 py-2 hover:text-[#FFEB3B] transition-colors duration-300"
                >
                  {service.shortTitle}
                </a>
                {/* Texto completo aparece al hover */}
                <span className="absolute hidden group-hover:block bg-white text-[#388E3C] px-4 py-2 text-sm font-semibold rounded shadow-md transition-all duration-300 top-full left-1/2 -translate-x-1/2 mt-2 z-10">
                  {service.title}
                </span>
              </li>
            ))}
    ...
    <section className="lg:mt-24">
      <div className="grid grid-cols-1 max-w-7xl mx-auto p-6 lg:grid lg:grid-cols-2 lg:items-center">
        <div className="lg:p-8">
          ...
          <p className="text-lg text-justify mb-6">{service.description}</p>
        </div>
        <div className="grid grid-cols-2 grid-rows-2 gap-2 lg:p-6 lg:shadow-xl lg:rounded-lg hover:shadow-2xl hover:scale-105 transition-all ">
