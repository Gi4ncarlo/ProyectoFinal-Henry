...
const ProviderCard: React.FC<IProviderCardProps> = ({ name, experience, profileImageUrl, calification }) => {
  ...
  return (
    <div className="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 cursor-pointer hover:shadow-lg transition-shadow">
      <Image
      ...
      <div className="px-5 pb-5">
        ...
        <div className="flex items-center mt-2.5 mb-5">
          ...
          <span className="ml-2 text-sm font-medium text-gray-500 dark:text-gray-400">{calification ? calification.toFixed(1) : 'N/A'}</span>
        </div>
      </div>
    </div>
  );
